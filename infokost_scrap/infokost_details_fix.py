...
def scrap(site: str, driver_path: str) -> int:
    ...
    try:    
        ...
        # driver.get('https://infokost.id/search-results/?location_search=Jakarta+Pusat%2C+Central+Jakarta+City%2C+Jakarta%2C+Indonesia&search_city=central-jakarta&search_area=central-jakarta-city&search_country=indonesia&lat=-6.1805113&lng=106.8283831&radius=4')
        # driver.get('https://infokost.id/search-results/?location_search=Jakarta%2C%20Indonesia&search_city&search_area&search_country=indonesia&lat=-6.2087634&lng=106.845599&radius=10')
        ...
        driver.get('https://infokost.id/search-results/?location_search=Bandung%2C+Bandung+City%2C+West+Java%2C+Indonesia&search_city=bandung&search_area=bandung-city&search_country=indonesia&lat=-6.9174639&lng=107.6191228&radius=10')
        ...
        # for p in range(1):  ## for testing purpose
            ...
            element = driver.find_elements(By.XPATH, LISTING_CARD)
        ...
        driver.quit()
        df2.to_csv("infokost_details_babandungan_fix.csv", index=False, sep='|')
